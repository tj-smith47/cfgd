...
//!     INSTA_UPDATE=always cargo test -p cfgd --test source_add_v2_snapshots
...
/// Strip non-deterministic spinner finish durations like ` (0.0s)` or ` (12.7s)`
/// so goldens survive runtime variance. Matches ` (` + digits + `.` + digits + `s)`.
