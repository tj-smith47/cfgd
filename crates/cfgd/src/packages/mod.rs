...
mod tests {
    ...
    use super::brew::parse_brew_versions;
    use super::cargo::{cargo_available, cargo_cmd, parse_cargo_install_list};
    use super::choco::{parse_choco_info_version, parse_choco_list};
    use super::go::{find_go, go_available, go_cmd, parse_go_module_version};
    use super::nix::parse_nix_search_version;
    use super::npm::{find_npm, npm_available, npm_cmd, parse_npm_list_versions};
    use super::parsers::{
        parse_apk_lines, parse_dnf_lines, parse_dnf_yum_lines, parse_pkg_lines, parse_simple_lines,
        parse_yum_lines, parse_zypper_lines,
    };
    use super::pipx::{find_pipx, parse_pipx_list_versions, pipx_available, pipx_cmd};
    use super::scoop::parse_scoop_list;
    #[cfg(target_os = "linux")]
    use super::shared::linux_system_manager_available;
    use super::shared::{
        PostInstallNote, any_system_manager_available, brew_available, brew_cmd, brew_path,
        extract_caveats, parse_version_field, print_caveats, run_pkg_cmd, run_pkg_cmd_msg,
        strip_arch_suffix, strip_sudo_if_root, strip_version_suffix, sudo_cmd,
    };
    use super::simple::{
        apk_manager, apt_manager, dnf_manager, pacman_manager, pkg_manager, yum_manager,
        zypper_manager,
    };
    use super::snap::parse_snap_info_version;
    use super::versions::{
        apt_aliases, dnf_aliases, parse_apt_versions, parse_rpm_versions,
        parse_tab_separated_versions,
    };
    use super::winget::parse_winget_list;
    use super::*;
