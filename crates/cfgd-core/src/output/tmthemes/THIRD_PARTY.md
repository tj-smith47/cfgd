...
| `nord.tmTheme` | `nord` | https://github.com/crabique/Nord-plist (`Nord.tmTheme`) | `bf92a9e4457dc2f97efebc59bbeac95933ec6515` | MIT |
...
Two presets read a port rather than the project's own repository, because the
project publishes no TextMate theme: `catppuccin/sublime-text` ships only
