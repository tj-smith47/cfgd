...
pub use format::{
    ...
    format_plan_item, format_plan_items, has_any_drift, hook_script_subject,
    module_file_resource_id, module_file_spec_resource_id, module_row_names_a_file,
    module_row_owner, module_scope, module_script_subject, module_script_subject_within,
